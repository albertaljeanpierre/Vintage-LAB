        ...
        initializeSubMenu: function(obj,depth)
        {
            ...
            obj.children("li").each(function(){
               ...
               if($(this).children("ul").length >0)
               {
                  ...
                  $(this).click(function(e){
                      //e.preventDefault(); // disabled default comportement preventDefault is deprecated
                      e.defaultPrevented; // disabled default comportement
                      e.returnValue = false; // for old IE
                      return false;// disabled all other action after
                  });
